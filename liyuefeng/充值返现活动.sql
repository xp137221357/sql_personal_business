set @param0 = '2016-08-26 00:00:00';
set @param1 = '2016-09-08 23:59:59';

-- 注册

set param=['2016-08-31 00:00:00','2016-09-08 23:59:59']; -- 分别填入起始时间，结束时间
select date(u.CRT_TIME) '时间',count(u.USER_ID) '注册人数' from forum.t_user u 
...
-- 充值金币
-- 官方+第三方充值
select date(tc.CRT_TIME ) '时间',count(distinct tc.charge_user_id) '充值人数',sum(tc.coins) '充值金币数',sum(tc.rmb_value) '充值金额'
