...
select count(distinct t.user_id) 'b使用人数' from t_user_match_recom t inner join t_match_recom r on t.RECOM_ID = r.RECOM_ID and r.`STATUS`=10 and r.SINGLE_MONEY>0
