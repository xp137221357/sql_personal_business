...
inner join report.t_trans_user_attr tu on m.USER_ID=tu.USER_ID and tu.CRT_TIME>='2017-01-01' and tu.CRT_TIME<'2017-06-01'
and  uc.ENTITY_TYPE='4'


;
select * from forum.t_user u where u.user_id ='1872093';
...
select t. from report.t_trans_user_recharge_coin t where t.crt_time>='2016-11-01'
...
inner join (
	...
	)tt on u.USER_ID=tt.charge_user_id and tt.crt_time>='2016-11-01' and u.`STATUS`=10 and u.NICK_NAME='爽锅锅'

) tc on m.USER_ID=tc.user_id
where  uc.ENTITY_TYPE='4' and m.READ_TIME>='2016-11-01';

-- 1872093
select * from  report.t_trans_user_recharge_coin  t where t.charge_user_id='1872093'
...
inner join t_chat_room r on r.ID=uc.ENTITY_ID  
inner join t_chat_room_member m on r.ID=m.CHAT_ID and m.IS_CREATE=1 
where  uc.ENTITY_TYPE='4' and uc.COMMENT_TIME>'2017-04-15' order by m.READ_TIME desc limit 10
and m.USER_ID in (
'9658992',
'9659334',
'9659448',
