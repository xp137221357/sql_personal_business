...
select '悬赏',u2.NICK_NAME '发送者',u.NICK_NAME '接收者', IFNULL(o.OFFER_GRATUITY,0) - IFNULL(o.OFFER_PRIZE,0)  '金币数',o.CRT_TIME '出题时间',oa.OFFER_APPLY_TIME '时间'
...
-- 用户出题，第三方答题，用户给第三方金币
select '答题',u2.NICK_NAME '发送者',u.NICK_NAME '接收者', IFNULL(o.OFFER_PRIZE,0) - IFNULL(o.OFFER_GRATUITY,0) '金币数',o.CRT_TIME '出题时间', oa.OFFER_APPLY_TIME '时间'
from game.t_offer_apply oa 
