...
insert t_stat_user_daily_balance 
select '2017-09-21',t.* from t_stat_user_daily_balance_0921 t;
...
ifnull(singin_prize_coin,0) '游戏签到奖励',
ifnull(admin_prize_coin,0) '游戏后台操作'
from t_acct_items_user_coin_detail t
inner join forum.t_user u on t.user_id=u.USER_ID
inner join report.t_stat_user_daily_balance t1 on u.user_code=t1.user_code and t.stat_date=t1.stat_date
