...
set @param0='2017-04-17';
set @param1='2017-04-23 23:59:59';
select 
tt1.stat_time '时间',
	                  ...
	                  FROM   forum.t_acct_items ai
	                         INNER JOIN forum.t_user u
	                                 ON u.user_id = ai.user_id
	                                    ...
	                                    AND u.group_type != 1
	                         LEFT JOIN forum.t_user_event tu
	                                ON ai.user_id = tu.user_id and tu.EVENT_CODE='reg'
...
left join (
	...
	select 
	   ...
	   t1.total_users ,
		...
		inner JOIN forum.t_user_event tu ON tc.charge_user_id = tu.user_id and tu.EVENT_CODE='reg'
