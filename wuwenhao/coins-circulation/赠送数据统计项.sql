...
set @beginTime='2016-10-06 00:00:00';
set @endTime = '2016-10-06 23:59:59';
...
union all
select 'P','系统账号派发',concat(@beginTime,'~',@endTime),sum(ai.COST_VALUE) from forum.t_acct_items ai 
inner join forum.v_user_system v on ai.user_id=v.USER_ID
where ai.item_event='USER_PRESENT' 
and ai.item_status = 10 
and ai.ADD_TIME >= '2016-06-01'  and ai.ADD_TIME <= '2016-08-01'
