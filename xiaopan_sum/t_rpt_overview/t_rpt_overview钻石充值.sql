...
-- 当天
insert into t_rpt_overview (period_type,period_name,device_type,channel_no,app_version,buy_diamond_unum,buy_diamond_amount) 
SELECT 1 period_type,
       ...
       count(DISTINCT u.user_id) buy_diamond_unum,
       ifnull(sum(ai.COST_VALUE), 0) AS buy_diamond_amount
  FROM forum.t_user u
...
buy_diamond_unum=VALUES(buy_diamond_unum) ,
buy_diamond_amount=VALUES(buy_diamond_amount);
