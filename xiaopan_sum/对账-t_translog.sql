...
and TO_DATE('19700101','yyyymmdd') + ((floor(t.CRT_TIME/1000)+28800)/86400) <= to_date('2017-01-01' ||' 23:59:59','yyyy-mm-dd hh24:mi:ss') 
...
from v_account_translog t 
where TO_DATE('19700101','yyyymmdd') + ((floor(t.CRT_TIME/1000)+28800)/86400) >= to_date( '2017-05-04' ||' 00:00:00','yyyy-mm-dd hh24:mi:ss')
and TO_DATE('19700101','yyyymmdd') + ((floor(t.CRT_TIME/1000)+28800)/86400) <= to_date('2017-05-04' ||' 23:59:59','yyyy-mm-dd hh24:mi:ss') 
and t.ACC_NAME not in ('3472351858331386256','6149208545176280651','8270936710946839603')
and t.ITEM_TYPE = 1001 AND T.STATUS = 10 
group by t.ACC_NAME
...
and TO_DATE('19700101','yyyymmdd') + ((floor(t.CRT_TIME/1000)+28800)/86400) <= to_date('2017-05-04' ||' 23:59:59','yyyy-mm-dd hh24:mi:ss') 
and t.ACC_NAME not in ('3472351858331386256','6149208545176280651','8270936710946839603')
and t.ITEM_TYPE = 1001 AND T.STATUS = 10 and t.ACC_NAME='3891564626740070363' 
order by t.CRT_TIME asc ;
