...
set @endTime = '2016-07-01 00:00:00';
...
date(rb.crt_time) '新增日期', date(o.ADD_TIME) '留存日期', ifnull(count(distinct o.USER_ID),0) '人数',sum(ifnull(o.COST_VALUE,0)) '金额',te.SYSTEM_MODEL '终端' FROM test.T_STAT_FIRST_RECHARGE_BET rb
INNER JOIN forum.t_acct_items o ON rb.USER_Id = o.USER_ID  and o.USER_ID not in (select user_id from test.v_user_vip)
inner join forum.t_user_event te on te.USER_ID = o.USER_ID and te.EVENT_CODE = 'REG' and te.SYSTEM_MODEL = 'ios'
