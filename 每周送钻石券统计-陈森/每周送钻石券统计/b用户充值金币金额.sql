...
select sum(substring_index(substring_index(t.COMMENTS, 'coin_num":', -1),',',1)) from t_acct_items t 
where t.ITEM_EVENT='buy_diamend' 
and (t.COMMENTS is not null and t.COMMENTS like '%buy_coin%')
and t.PAY_TIME>'2017-01-20 00:00:00'
and t.PAY_TIME< ADDDATE('2017-01-20 00:00:00', 7)
