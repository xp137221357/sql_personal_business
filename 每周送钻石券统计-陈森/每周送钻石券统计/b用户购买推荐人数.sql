...
select count(distinct t.user_id) from t_user_match_recom t inner join t_match_recom r on t.RECOM_ID = r.RECOM_ID and r.`STATUS`=10 and r.SINGLE_MONEY>0
where t.PAY_STATUS=10
and t.CRT_TIME>'2017-01-20 00:00:00'
and t.CRT_TIME< ADDDATE('2017-01-20 00:00:00', 7)
and t.USER_ID in
(
